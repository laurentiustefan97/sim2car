...
public class EmergencyPersonality implements Personality {
	private double coef2, coef3, coef4, coef5, coef6, coef7, coef8,
			coef9, coef10;

	public EmergencyPersonality() {
	...
	public double getWantedSpeed(long id) {
		...
		return way.getMaximumSpeed() * (1.0 + Globals.speedIncreaseEmergencyVehicles) + coef9;
	}
